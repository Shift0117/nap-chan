...
use songbird::{SerenityInit, Driver, ffmpeg, create_player};
...
#[group]
#[commands(join, leave, mute, play, ping, unmute,play_youtube,deafen,undeafen)]
struct General;
...
#[command]
#[only_in(guilds)]
async fn play_youtube(ctx: &Context, msg: &Message, mut args: Args) -> CommandResult {
